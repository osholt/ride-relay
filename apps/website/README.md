...
+ Brew venue directory. Catalogue matching stays in the browser. Ride names
and generated GPX files also stay in the browser; route coordinates and other
place queries go only to the documented providers. Cloudflare Pages is
connected directly to this repository and publishes the site automatically
from `main`.
